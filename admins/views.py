...
def adminML(request):
    ...
    print("The accuracy score achieved using Linear regression is: " + str(score_lr) + " %")  #one_algorithm
    ...
    print("The accuracy score achieved using Linear SVM is: " + str(score_svm) + " %") #two_algorithm
    ...
    print("The accuracy score achieved using KNN is: " + str(score_knn) + " %")  #three_algorithm
    ...
    print("The accuracy score achieved using Decision Tree is: " + str(score_dt) + " %") #four_algorithm
    ...
    algorithms = ["Logistic Regression", "SVM", "K-Nearest Neighbors", "Decision Tree"]
    rsltDict = {}
    for i in range(len(algorithms)):
        print("The accuracy score achieved using " + algorithms[i] + " is: " + str(scores[i]) + " %")
        rsltDict.update({algorithms[i]: scores[i]})
    ...
    plt.bar(algorithms, scores, color='maroon',
            width=0.4)
    ...
    return render(request, 'admins/AdminViewResults.html', {'rslt': rsltDict})
